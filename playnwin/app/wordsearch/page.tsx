    ...
    <main className="min-h-screen lg:h-auto h-[100dvh] flex flex-col px-4 py-4 overflow-hidden">
      ...
      <div className="w-full max-w-[420px] mx-auto flex flex-col h-full lg:hidden">
        <header className="relative flex items-center justify-between w-full mb-4 flex-shrink-0">
          ...
          <h1 className="text-lg font-bold text-white absolute left-1/2 -translate-x-1/2">Word Search</h1>
          <div className="z-10">
        ...
        {(!isAuthenticated || playsRemaining === 0) && (
          <div className="text-center mb-4 p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex-shrink-0">
        ...
        {!isAuthenticated && (
          <div className="mt-4 flex-shrink-0">
            <button onClick={() => setIsAuthModalOpen(true)} className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold rounded-xl hover:opacity-90 transition-all">
      ...
      <div className="hidden lg:flex flex-col w-full max-w-5xl mx-auto py-8">
        <header className="relative flex items-center justify-between w-full mb-8">
          ...
          <h1 className="text-2xl font-bold text-white absolute left-1/2 -translate-x-1/2">Word Search</h1>
          <div className="z-10">
            <RecentWinnersMenu gameType="wordsearch" fetchWinners={fetchRecentWordSearchWinners} refreshTrigger={refreshTrigger} />
          </div>
        </header>
        ...
        {/* Guest/No Rewards Banner */}
        {(!isAuthenticated || playsRemaining === 0) && (
          <div className="text-center mb-8 p-4 rounded-xl bg-cyan-500/10 border border-cyan-500/20 max-w-2xl mx-auto">
