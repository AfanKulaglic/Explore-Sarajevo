...
/**
 * Redirect to accounts to set the Supabase session cookie first-party on accounts,
 * then return to returnUrl (cross-site SSO).
 */
...
/**
 * Link session to central auth for cross-site SSO (full browser redirect).
 */
